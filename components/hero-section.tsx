  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        <h1 className="font-serif text-3xl font-bold leading-tight text-primary-foreground/80 md:text-4xl lg:text-5xl text-balance whitespace-pre-line">
          {"Tworzymy przestrzenie,\nktóre inspirują"}
        </h1>
        <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-primary-foreground/60 md:text-lg text-pretty">

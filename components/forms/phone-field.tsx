...
const STYLES: Record<Variant, { control: string; error: string }> = {
  ...
  dark: {
    control:
      "rounded-lg bg-primary-foreground/10 border border-primary-foreground/10 text-primary-foreground placeholder:text-primary-foreground/40 px-4 py-3 focus:outline-none focus:border-primary",
